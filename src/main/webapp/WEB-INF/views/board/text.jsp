						...
						<form id="frm" class="form-horizontal" role="form"
							...
							<div class="form-group">
								...
								<div class="col-sm-10">
									...
									<input type="hidden" id="text_content" name="text_content" value="${textVo.text_content }"/>
								</div>
							</div>
							...
							<c:choose>
								...
								<c:otherwise>
									<div class="form-group">
										...
										<div class="col-sm-2">
											<button type="button">
												<a href="${pageContext.request.contextPath }/delete?text_id=${textVo.text_id}&&userid=${textVo.userid}&&board_id=${textVo.board_id}">
												게시글삭제</a>
											</button>
										</div>
									</div>
